...
@Service
public class HouseCalculationServiceImpl implements HouseCalculationService {
    ...
    @Override
    public String performApiRequest(String apiURL) throws IOException {
        ...
        try {
            ...
            throw new IOException("API request failed: " + e.getMessage());
        }
        finally {
    ...
    public String handleDaysOnMarketApiRequest(String apiURL) {
        ...
        try {
            ...
            return String.valueOf(jsonNode.get("days_on_market"));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public String produceRatingAnalysis(String investmentRating, String cashFlow, String vacancyRate,
        ...
        if (purchasePriceDouble <= 200000 && cashFlowDouble > 0) {
            ...
            purchasePriceDescription = "This property is mid-priced, offering a balance between affordability and desirable features." +
                    " Compared to lower priced properties, this may provide more space, a better finish, and improved amenities. Since the cash flow is " +
